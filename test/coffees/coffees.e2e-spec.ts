        ...
        describe('when coffee data is incorrect', () => {
            ...
            it('should return 400 if name is too short', async () => {
                return request(app.getHttpServer())
                    ...
                    .expect(HttpStatus.BAD_REQUEST)
                    .then(({ body }) => {
                        expect(body.message).toEqual(['name must be longer than or equal to 3 characters']);
                    });
            });
            ...
            it('should return 400 if name is too long', async () => {
                return request(app.getHttpServer())
                    ...
                    .expect(HttpStatus.BAD_REQUEST)
                    .then(({ body }) => {
                        expect(body.message).toEqual(['name must be shorter than or equal to 255 characters']);
                    });
            });
            ...
            it('should return 400 if brand is too short', async () => {
                return request(app.getHttpServer())
                    ...
                    .expect(HttpStatus.BAD_REQUEST)
                    .then(({ body }) => {
                        expect(body.message).toEqual(['brand must be longer than or equal to 3 characters']);
                    });
            });
            ...
            it('should return 400 if brand is too long', async () => {
                return request(app.getHttpServer())
                    ...
                    .expect(HttpStatus.BAD_REQUEST)
                    .then(({ body }) => {
                        expect(body.message).toEqual(['brand must be shorter than or equal to 255 characters']);
                    });
            });
            ...
            it('should return 400 if flavors is not an array', async () => {
                return request(app.getHttpServer())
                    .post('/coffees')
                    .send({ ...coffee, flavors: 'chocolate' as unknown as string[] } as CreateCoffeeDto)
                    .expect(HttpStatus.BAD_REQUEST)
                    .then(({ body }) => {
                        expect(body.message).toEqual(['All flavors\'s elements must be unique', 'flavors must be an array']);
                    });
            });
            ...
            it('should return 400 if flavors is not an array of strings', async () => {
                return request(app.getHttpServer())
                    .post('/coffees')
                    .send({ ...coffee, flavors: [1, 2, 3] as unknown as string[] } as CreateCoffeeDto)
                    .expect(HttpStatus.BAD_REQUEST)
                    .then(({ body }) => {
                        expect(body.message).toEqual(['each value in flavors must be a string']);
                    });
            });
        });
            ...
            describe('when coffee with id does not exist', () => {
                ...
                it('should return 404 if id is not a number', async () => {
                    return request(app.getHttpServer())
                        ...
                        .expect(HttpStatus.BAD_REQUEST)
                        .then(({ body }) => {
                            expect(body.message).toEqual('Validation failed (numeric string is expected)');
                        });
                });
            });
        });
    ...
    describe('Update one [PATCH /:id]', () => {
        ...
        describe('when payload is incorrect', () => {
            ...
            it('should return 400 if flavors is not an array', async () => {
                return request(app.getHttpServer())
                    .patch('/coffees/1')
                    .send({ flavors: 'chocolate' as unknown as string[] } as UpdateCoffeeDto)
                    .expect(HttpStatus.BAD_REQUEST)
                    .then(({ body }) => {
                        expect(body.message).toEqual(['All flavors\'s elements must be unique', 'flavors must be an array']);
                    });
            ...
            it('should return 400 if flavors is not an array of strings', async () => {
                return request(app.getHttpServer())
                    .patch('/coffees/1')
                    .send({ flavors: [1, 2, 3] as unknown as string[] } as UpdateCoffeeDto)
                    .expect(HttpStatus.BAD_REQUEST)
                    .then(({ body }) => {
                        expect(body.message).toEqual(['each value in flavors must be a string']);
                    });
